...
$logoInfo = getLogoInfo(array('src' => "/images/f66f8711-2942-4a88-b7bc-12df544fddc2-54.png"));
    ...
    <script type="application/ld+json">
{
    ...
    "publisher": {
        "@type": "Organization",
          "logo": {
            "@type": "ImageObject",
            "height": "<?php echo $logoInfo['height']; ?>",
            "width": "<?php echo $logoInfo['width']; ?>",
            "url": "<?php echo $logoInfo['src']; ?>"
          },
