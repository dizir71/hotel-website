...
?><div class="u-form-group u-form-name"><!--login_form_usernameLabel-->
          <label for="[[label_for]]" class="u-label" name="[[label_name]]">[[label_content]]</label><!--/login_form_usernameLabel--><!--login_form_username-->
          <input type="[[input_type]]" placeholder="[[input_placeholder]]" id="[[input_id]]" name="[[input_name]]" class="u-border-grey-30 u-input u-input-rectangle u-input-1" required=""><!--/login_form_username-->
        </div><?php
