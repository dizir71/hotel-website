...
ob_start();
?>
	<nav class="hmenu u-align-center u-dropdown-icon u-menu u-menu-dropdown u-offcanvas u-menu-1" data-position="hmenu">
          <div class="menu-collapse u-custom-font u-font-montserrat" style="font-size: 1.28571rem; letter-spacing: 0px; font-weight: 700;">
            <a class="u-button-style u-custom-active-border-color u-custom-border u-custom-border-color u-custom-borders u-custom-hover-border-color u-custom-left-right-menu-spacing u-custom-padding-bottom u-custom-text-active-color u-custom-text-color u-custom-text-hover-color u-custom-text-shadow u-custom-top-bottom-menu-spacing u-nav-link u-text-active-palette-1-base u-text-hover-palette-2-base" href="#">
              <svg class="u-svg-link" viewBox="0 0 24 24"><use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#svg-2259"></use></svg>
              <svg class="u-svg-content" version="1.1" id="svg-2259" viewBox="0 0 16 16" x="0px" y="0px" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns="http://www.w3.org/2000/svg"><g><rect y="1" width="16" height="2"></rect><rect y="7" width="16" height="2"></rect><rect y="13" width="16" height="2"></rect>
</g></svg>
            </a>
          </div>
...
$menu_html = buildMenu1($mainList, $default_id, $active_id, $path, array(
        'container_class' => 'hmenu u-align-center u-dropdown-icon u-menu u-menu-dropdown u-offcanvas u-menu-1',
        'menu_class' => 'u-custom-font u-font-montserrat u-nav u-spacing-20 u-unstyled u-nav-1',
        'item_class' => 'u-nav-item',
        'link_class' => 'u-border-active-palette-1-base u-border-hover-palette-1-base u-button-style u-nav-link u-text-active-palette-1-light-2 u-text-hover-white u-text-palette-1-dark-2',
        'link_style' => 'padding: 10px;',
        'submenu_class' => 'u-border-2 u-border-palette-1-light-2 u-h-spacing-20 u-nav u-unstyled u-v-spacing-5',
        'submenu_item_class' => 'u-nav-item',
        'submenu_link_class' => 'u-button-style u-hover-palette-1-light-2 u-nav-link u-palette-1-light-1',
        'submenu_link_style' => '',
        'megamenu_on' => '',
        'mega_submenu_class' => '',
